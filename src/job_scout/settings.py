    ...
    def from_env(cls) -> Settings:
        ...
        return cls(
            ...
            career_llm_model=os.getenv(
                "CAREER_LLM_MODEL", "Bielik-11B-v3.0-Instruct.Q4_K_M.gguf"
            ),
            ...
            career_llm_base_url=os.getenv(
                "CAREER_LLM_BASE_URL", "http://127.0.0.1:8001/v1"
            ),
            ...
            career_llm_autostart=os.getenv(
                "CAREER_LLM_AUTOSTART", "true"
            ).lower()
            in {"1", "true", "yes", "on"},
            career_llm_speculative_type=(
                os.getenv("CAREER_LLM_SPECULATIVE_TYPE") or None
            ),
